var capacitorGoogleSignIn = (function (exports, core) {
    'use strict';
    ...
    const GoogleSignIn = core.registerPlugin('GoogleSignIn', {
        web: () => Promise.resolve().then(function () { return web; }).then(m => new m.GoogleSignInWeb()),
    });
    ...
    class GoogleSignInWeb extends core.WebPlugin {
    ...
    var web = /*#__PURE__*/Object.freeze({
        __proto__: null,
        GoogleSignInWeb: GoogleSignInWeb
    });
